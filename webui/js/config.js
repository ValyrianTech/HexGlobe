...
const CONFIG = {
    ...
    resolutionLayers: {
        0: { radius: 1.0, visible: true },
        1: { radius: 1.02, visible: false },
        2: { radius: 1.04, visible: false },
        3: { radius: 1.06, visible: false },
        4: { radius: 1.08, visible: false },
        5: { radius: 1.10, visible: false }
    },
